...
from fitnesssite.user import login_required
from fitnesssite.db import get_db
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if weight < 0 or height < 0:
                error = 'Your weight and height must be greater than zero.'

            if metrics == 'inches and pounds':
                bmi =  float((weight*703)/(height**2))
            elif metrics == 'meters and kilograms': 
